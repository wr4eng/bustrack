...
public class BulletinBoardViewContainer extends AbstractViewContainer {
	...
	private static ThreadLocal<BulletinBoardService> threadBulletinBoardService = new ThreadLocal<BulletinBoardService>();
	 ...
	 * visual editor.
	 */
	public BulletinBoardViewContainer(IWorkbenchContext context) {
		buildMainLayout();
	...
	private void createViews() {
		...
		threadBulletinBoardService.set(bulletinBoardService);
		
		// add all views controlled by SliderView Component
		bulletinBoardView = new BulletinBoardView(this);
		sliderView.addView(bulletinBoardView);
		views.put(0, bulletinBoardView);
	}
	...
	private void destroyViews() {
		...
		threadBulletinBoardService.set(null);
		
	}
	
    public static BulletinBoardService getBulletinBoardService() {
        return threadBulletinBoardService.get();
