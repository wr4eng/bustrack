...
public class TurnViewContainer extends AbstractViewContainer {
	...
	private static ThreadLocal<TurnService> threadTurnService = new ThreadLocal<TurnService>();	
	...
	public TurnViewContainer (IWorkbenchContext context) {
		buildMainLayout();
