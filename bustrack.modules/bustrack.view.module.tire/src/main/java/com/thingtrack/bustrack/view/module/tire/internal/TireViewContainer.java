...
public class TireViewContainer extends AbstractViewContainer {
	...
	private static ThreadLocal<TireService> threadTireService = new ThreadLocal<TireService>();
	 ...
	 * visual editor.
	 */
	public TireViewContainer(IWorkbenchContext context) {
		buildMainLayout();
	...
	private void createViews() {
		...
		threadTireService.set(tireService);
		
		// add all views controlled by SliderView Component
		tireView = new TireView(this);
		sliderView.addView(tireView);
		views.put(0, tireView);
	}
	...
	private void destroyViews() {
		...
		threadTireService.set(null);
		
	}
	
    public static TireService getTireService() {
        return threadTireService.get();
