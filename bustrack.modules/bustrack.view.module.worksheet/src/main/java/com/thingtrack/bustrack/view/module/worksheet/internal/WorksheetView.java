...
public class WorksheetView extends AbstractView implements ClickFilterButtonListener, ClickPrintButtonListener {
	...
	private BindingSource<EmployeeAgent> bsDriver = new BindingSource<EmployeeAgent>(EmployeeAgent.class, 0);
	...
	private void initView() {
		...
		try {
			...
			dgDrivers.setVisibleColumns(new String[] { "workNumber", "name", "surname", "nif" } );
			dgDrivers.setColumnHeaders(new String[] { "Número Trabajador", "Nombre", "Apellidos", "NIF"} );	
		...
		boxToolbar = new BoxToolbar(1, bsDriver);
	...
	private class WorksheetAssignmentColumn implements ColumnGenerator {
	...
	public void printButtonClick(ClickNavigationEvent event) {
		try {
			dgDrivers.print("Listado Partes Trabajo");
		}
		catch (Exception e) {
