...
public class GasStationRegisterViewContainer extends AbstractViewContainer {
	...
	/** Views **/
	private GasStationRegisterView gasStationRegisterView;
	...
	private static ThreadLocal<GasStationRegisterService> threadGasStationRegisterService = new ThreadLocal<GasStationRegisterService>();
	 ...
	 * visual editor.
	 */
	public GasStationRegisterViewContainer(IWorkbenchContext context) {
		buildMainLayout();
	...
	private void createViews() {
		...
		threadGasStationRegisterService.set(gasStationRegisterService);
		
		// add all views controlled by SliderView Component
		gasStationRegisterView = new GasStationRegisterView(this);
		sliderView.addView(gasStationRegisterView);
		views.put(0, gasStationRegisterView);
	}
	...
	private void destroyViews() {
		...
		threadGasStationRegisterService.set(null);
		
	}
	
    public static GasStationRegisterService getGasStationRegisterService() {
        return threadGasStationRegisterService.get();
