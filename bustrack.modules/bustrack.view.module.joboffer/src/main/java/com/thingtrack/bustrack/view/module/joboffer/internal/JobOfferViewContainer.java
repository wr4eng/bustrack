...
public class JobOfferViewContainer extends AbstractViewContainer {
	...
	private static ThreadLocal<JobOfferService> threadJobOfferService = new ThreadLocal<JobOfferService>();
	 ...
	 * visual editor.
	 */
	public JobOfferViewContainer(IWorkbenchContext context) {
		buildMainLayout();
	...
	private void createViews() {
		...
		threadJobOfferService.set(jobOfferService);
		
		// add all views controlled by SliderView Component
		jobOfferView = new JobOfferView(this);
		sliderView.addView(jobOfferView);
		views.put(0, jobOfferView);
	}
	...
	private void destroyViews() {
		...
		threadJobOfferService.set(null);
		
	}
	
    public static JobOfferService getJobOfferService() {
        return threadJobOfferService.get();
