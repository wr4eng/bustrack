...
//		mHandle.setOnHoverListener(new View.OnHoverListener() {
//			
//			@Override
//			public boolean onHover(View v, MotionEvent event) {
//					 switch (event.getAction()) {
//	                 case MotionEvent.ACTION_HOVER_ENTER:
//	                	 	Log.d("TEST", "Hover Enter !!!");
//	                     break;
//	                 case MotionEvent.ACTION_HOVER_MOVE:
//	                	 	//Log.d("TEST", "Hover Move !!!");
//	                     break;
//	                 case MotionEvent.ACTION_HOVER_EXIT:
//	                	 	Log.d("TEST", "Hover Exit !!!");
//	                     break;
//	             }
//				return false;
//			}
//		});
	...
	public boolean onCrossViewInterceptTouchEvent(MotionEvent event, int action, View handle, int x, int y) {
	...
	private void doAnimation()
	{
		if ( mAnimating ) {
			...
			Log.i("MultiDirectionSlidingDrawer", "Animated Position: " + mAnimationPosition);
