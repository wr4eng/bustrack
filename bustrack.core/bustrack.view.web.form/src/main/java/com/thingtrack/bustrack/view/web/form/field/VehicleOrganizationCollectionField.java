...
public class VehicleOrganizationCollectionField extends CustomField {
	 ...
	 * visual editor.
	 */
	public VehicleOrganizationCollectionField() {
		buildMainLayout();
		...
		organizationsTable.addGeneratedColumn(VehicleAssignmentColumn.VEHICLE_COLUMN_ID, new VehicleAssignmentColumn());
		organizationsTable.setVisibleColumns(new String[]{"cif", "description", VehicleAssignmentColumn.VEHICLE_COLUMN_ID});
	...
	private class VehicleAssignmentColumn implements Table.ColumnGenerator{

		static final String VEHICLE_COLUMN_ID = "vehicle-assignment";
