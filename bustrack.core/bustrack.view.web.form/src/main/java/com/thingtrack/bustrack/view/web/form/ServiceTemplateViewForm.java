...
public class ServiceTemplateViewForm extends CustomComponent {
	 ...
	 * editor.
	 */
	public ServiceTemplateViewForm() {
		buildMainLayout();
	...
	private AbsoluteLayout buildMainLayout() {
		...
		fileField.setCaption("Adjuntar Plantilla Excel");		
		fileField.setImmediate(true);
		fileField.setWidth("340px");
		fileField.setHeight("-1px");
		mainLayout.addComponent(fileField, "top:17.0px;left:200.0px;");
