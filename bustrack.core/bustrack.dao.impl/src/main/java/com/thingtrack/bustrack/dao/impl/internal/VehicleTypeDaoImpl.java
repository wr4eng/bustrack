 ...
 */
@Repository
public class VehicleTypeDaoImpl extends JpaDao< VehicleType, Integer> implements VehicleTypeDao {
	/* (non-Javadoc)
	 * @see com.thingtrack.bustrack.dao.api.VehicleTypeDao#getByName(java.lang.String)
	 */
	@Override
	public VehicleType getByCode(String code) throws Exception {
		VehicleType vehicleType = (VehicleType)getEntityManager()
				.createQuery("SELECT p FROM " + getEntityManager() + " p where p.code = :code")
