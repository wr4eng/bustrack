/*
WHERE * Copyright 2011 Thingtrack, S.L.
 *
 ...
 */
@Repository
public class GasStationDaoImpl extends JpaDao<GasStation, Integer> implements GasStationDao {
	/* (non-Javadoc)
	 * @see com.thingtrack.bustrack.dao.api.GasStationDao#getByCode(java.lang.String)
	 */
	@Override
	public GasStation getByCode(String code) throws Exception {
		GasStation gasStation = (GasStation)getEntityManager()
