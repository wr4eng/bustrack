 ...
 */
@Repository
public class GasStationTypeDaoImpl extends JpaDao<GasStationType, Integer> implements GasStationTypeDao {
	/* (non-Javadoc)
	 * @see com.thingtrack.bustrack.dao.api.GasStationTypeDao#getByCode(java.lang.String)
	 */
	@Override
	public GasStationType getByCode(String code) throws Exception {
		GasStationType gasStationType = (GasStationType)getEntityManager()
