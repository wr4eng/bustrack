 ...
 */
@Repository
public class TireStatusDaoImpl extends JpaDao<TireStatus, Integer> implements TireStatusDao {
	/* (non-Javadoc)
	 * @see com.thingtrack.bustrack.dao.api.TireStatusDao#getByCode(java.lang.String)
	 */
	@Override
	public TireStatus getByCode(String code) throws Exception {
		TireStatus tireStatus = (TireStatus)getEntityManager()
